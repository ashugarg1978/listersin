	...
	function items()
	{
		...
		foreach ($res as $idx => $row) {
			...
			if ($i['listingstatus'] == 'Active') {
				$item['listingstatus_label'] = '<span style="color:green">¡ü</span>';
			} else if ($i['listingstatus'] == 'Completed') {
				$item['listingstatus_label'] = '<span style="color:gray">¢®</span>';
			} else {
				$item['listingstatus_label'] = '<span style="color:#cccccc">¢®</span>';
			}
