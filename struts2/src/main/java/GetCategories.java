...
public class GetCategories extends ApiCall implements Callable {
	...
	public GetCategories (Integer siteid, String site) {
		this.siteid = siteid;
		this.site   = site;
	}
	...
	public String call() throws Exception {
		...
		requestdbobject.append("CategorySiteID", siteid.toString());
		
		JSONObject requestjsonobject = JSONObject.fromObject(requestdbobject.toString());
		
		XMLSerializer xmls = new XMLSerializer();
		xmls.setObjectName("GetCategories");
		...
		writelog("GetCategories."+site+".res.xml", responsexml);
