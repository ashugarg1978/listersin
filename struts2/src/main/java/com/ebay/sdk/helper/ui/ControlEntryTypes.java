...
public interface ControlEntryTypes
{
  ...
  static ControlTagItem[] itemTypes = new ControlTagItem[] {
      new ControlTagItem(ItemTypeFilterCodeType.ALL_ITEMS.value(), ItemTypeFilterCodeType.ALL_ITEMS),
      new ControlTagItem(ItemTypeFilterCodeType.AUCTION_ITEMS_ONLY.value(), ItemTypeFilterCodeType.AUCTION_ITEMS_ONLY),
      new ControlTagItem(ItemTypeFilterCodeType.FIXED_PRICED_ITEM.value(), ItemTypeFilterCodeType.FIXED_PRICED_ITEM)
  };

  static ControlTagItem[] listingOrders = new ControlTagItem[] {
      new ControlTagItem(CategoryListingsOrderCodeType.NO_FILTER.value(), CategoryListingsOrderCodeType.NO_FILTER),
      new ControlTagItem(CategoryListingsOrderCodeType.ITEMS_BY_24_HR.value(), CategoryListingsOrderCodeType.ITEMS_BY_24_HR),
      //new ControlTagItem(CategoryListingsOrderCodeType.ItemsEndToday.toString(), CategoryListingsOrderCodeType.ItemsEndToday),
      //new ControlTagItem(CategoryListingsOrderCodeType.ItemsEndIn5Hr.toString(), CategoryListingsOrderCodeType.ItemsEndIn5Hr),
      new ControlTagItem(CategoryListingsOrderCodeType.SORT_BY_PRICE_ASC.value(), CategoryListingsOrderCodeType.SORT_BY_PRICE_ASC),
      new ControlTagItem(CategoryListingsOrderCodeType.SORT_BY_PRICE_DESC.value(), CategoryListingsOrderCodeType.SORT_BY_PRICE_DESC),
      new ControlTagItem(CategoryListingsOrderCodeType.DISTANCE_SORT.value(), CategoryListingsOrderCodeType.DISTANCE_SORT)
  };
  ...
  static ControlTagItem[] notificationEvents = new ControlTagItem[] {
      ...
      new ControlTagItem(NotificationEventTypeCodeType.FIXED_PRICE_END_OF_TRANSACTION.value(), NotificationEventTypeCodeType.FIXED_PRICE_END_OF_TRANSACTION),
