 ...
 * <br> <B>Input property:</B> <code>MaxDepth</code> - Specifies the number of levels of subfolders to be returned.
 * <br> <B>Input property:</B> <code>FullRecursion</code> - Displays the entire tree of a user's folders. If this is provided, the other two values
 * need not be given.
