 ...
 * item end time. Specify either the end-time range or the start-time range
 * filter in every request. Each of the time ranges must be a value less than
 * 120 days.
 ...
 * Specifies the earliest (oldest) date to use in a date range filter based on
 * item start time. Specify either the end time range or start time range
 * filter in every request. Each of the time ranges must be a value less than
 * 120 days.
