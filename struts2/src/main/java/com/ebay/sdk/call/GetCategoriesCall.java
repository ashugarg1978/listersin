 ...
 * <br> <B>Input property:</B> <code>ViewAllNodes</code> - If false or omitted, retrieves only leaf categories.
...
public class GetCategoriesCall extends com.ebay.sdk.ApiCall
{
  ...
  private boolean viewAllNodes = false;
      ...
      throws com.ebay.sdk.ApiException, com.ebay.sdk.SdkException, java.lang.Exception
  {
    ...
    req.setViewAllNodes(new Boolean(this.viewAllNodes));
