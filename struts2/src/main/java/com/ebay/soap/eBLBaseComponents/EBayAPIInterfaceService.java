 ...
 * 
 */
@WebServiceClient(name = "eBayAPIInterfaceService", targetNamespace = "urn:ebay:apis:eBLBaseComponents", wsdlLocation = "file:/var/www/dev.xboo.st/struts2/src/main/resources/eBaySvc.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "file:/var/www/dev.xboo.st/struts2/src/main/resources/eBaySvc.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/var/www/dev.xboo.st/struts2/src/main/resources/eBaySvc.wsdl', retrying as a local file");
