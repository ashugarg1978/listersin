...
public interface EBayAPIInterface {
     ...
     * @return
     *     returns com.ebay.soap.eBLBaseComponents.GetCategoryListingsResponseType
     */
     ...
     * @return
     *     returns com.ebay.soap.eBLBaseComponents.GetPopularKeywordsResponseType
     */
     ...
     * @return
     *     returns com.ebay.soap.eBLBaseComponents.GetProductsResponseType
     */
    @WebMethod(operationName = "GetProducts")
    @WebResult(name = "GetProductsResponse", targetNamespace = "urn:ebay:apis:eBLBaseComponents", partName = "GetProductsResponse")
    public GetProductsResponseType getProducts(
        @WebParam(name = "GetProductsRequest", targetNamespace = "urn:ebay:apis:eBLBaseComponents", partName = "GetProductsRequest")
        GetProductsRequestType getProductsRequest);
     ...
     * @return
     *     returns com.ebay.soap.eBLBaseComponents.GetSearchResultsResponseType
     */
    @WebMethod(operationName = "GetSearchResults")
    @WebResult(name = "GetSearchResultsResponse", targetNamespace = "urn:ebay:apis:eBLBaseComponents", partName = "GetSearchResultsResponse")
    public GetSearchResultsResponseType getSearchResults(
        @WebParam(name = "GetSearchResultsRequest", targetNamespace = "urn:ebay:apis:eBLBaseComponents", partName = "GetSearchResultsRequest")
